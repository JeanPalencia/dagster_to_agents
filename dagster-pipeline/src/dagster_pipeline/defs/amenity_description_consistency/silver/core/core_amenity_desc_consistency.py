...
MODIFIED 2026-04-14: adc_mention_rate rounding changed from 2 to 4 decimals.
Reason: Increase precision to match production data requirements.
Affects: gold_amenity_desc_consistency, rpt_amenity_desc_consistency (S3 + GeoSpot).
"""
import re
...
def core_amenity_desc_consistency(
    ...
    for row in df.iter_rows(named=True):
        ...
        results.append({
            ...
            "adc_mention_rate": round(rate, 4),  # Rounded to 4 decimals (changed 2026-04-14 from 2)
