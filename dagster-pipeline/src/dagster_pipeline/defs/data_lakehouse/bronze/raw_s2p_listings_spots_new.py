# defs/data_lakehouse/bronze/raw_s2p_listings_spots_new.py
...
raw_s2p_listings_spots_new = make_bronze_asset("mysql_prod", tags=TAGS_LK_SPOTS_BRONZE, table_name="listings_spots")
