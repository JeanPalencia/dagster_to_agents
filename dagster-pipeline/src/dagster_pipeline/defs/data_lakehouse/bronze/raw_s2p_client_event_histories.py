# defs/data_lakehouse/bronze/raw_s2p_client_event_histories.py
...
@dg.asset(
    ...
    group_name="bronze",
    description="Bronze: raw extraction de client_event_histories from Spot2 Platform.",
)
def raw_s2p_client_event_histories(context: dg.AssetExecutionContext):
    def body():
        query = """
        SELECT
           *
        ...
        context.log.info(f"raw_s2p_client_event_histories: {df.height} rows for {context.partition_key}")
